                      ...
                      children: [
                        Expanded(child: Row(
                          children: [
                            Expanded(child:Container (child: ClipRRect(
                              ...
                              child: Image.network('https://t4.ftcdn.net/jpg/02/80/57/07/360_F_280570712_LuChCGd4YkvXq2ksFSD6cTKgGj3mKnCW.jpg',height: 50,width: 50,),
                            ),

                            )),
                            Expanded(child: Container(child: Text("milk"),)),
                            Expanded(child: Container(margin: EdgeInsets.only(left: 100),child: Text("1 L"),)),
                          ],
                        )),
                        Expanded(child: Row(
                          children: [
                            Expanded(child:Container (child: ClipRRect(
                              borderRadius: BorderRadius.circular(25),
                              child: Image.network('https://thumbs.dreamstime.com/b/ghee-butter-jar-vector-icon-healthy-eating-cartoon-illustration-ghee-butter-jar-vector-icon-healthy-eating-cartoon-illustration-119378855.jpg',height: 50,width: 50,),
                            ),

                            )),
                            Expanded(child: Container(child: Text("ghee"),)),
                        ...
                        Expanded(child: Row(
                          children: [
                            ...
                            Expanded(child: Container(child: Text("corn flour"),)),
